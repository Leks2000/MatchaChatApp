...
android {
  ...
  defaultConfig {
    applicationId = "com.aistudio.matchachat.kgtwqz"
    minSdk = 24
    targetSdk = 35
    versionCode = 1
    versionName = "1.0"
    ...
    // Dynamic resolution of GROQ_API_KEY for robust local and cloud/AI Studio support
